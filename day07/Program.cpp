...
std::vector<int> Program::convertProgramToInts(const std::string &inputProgram) {
...
Program::ParameterMode Program::readParameterMode(int value, int parameterNumber) {
...
//    std::cout << "[OUTPUT] " << _program[_program[_programPointer + 1]] << std::endl;
