...
void Program::handleADD(Instruction instruction) {
    ...
    std::cout << "[" << address << "]" << " = " << firstArgument << " + " << secondArgument << std::endl;
...
void Program::handleINPUT(Instruction instruction, long input) {
    ...
    std::cout << "[" << firstArgument << "]" << " = " << input << std::endl;
...
void Program::handleJUMP_IF_TRUE(Instruction instruction) {
    ...
    std::cout << firstArgument << " != 0" << ", jump to: " << secondArgument <<std::endl;
...
void Program::handleLESS_THAN(Instruction instruction) {
    ...
    std::cout << firstArgument << " < "  << secondArgument << " out address: [" << address << "]" << std::endl;
...
void Program::handleEQUALS(Instruction instruction) {
    ...
    std::cout << firstArgument << " == "  << secondArgument << "[" << address << "]" << std::endl;
    if (firstArgument == secondArgument)
        _program[address] = 1;
    else
        _program[address] = 0;
